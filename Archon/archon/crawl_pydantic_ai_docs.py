    ...
    try:
        ...
        if not result.get('title') or not result.get('summary'):
            ...
            if not result.get('title'):
                result['title'] = f"Pydantic AI Documentation: {page_name}"
        ...
        first_line = chunk.split('\n')[0][:50].strip() if chunk else "Pydantic AI Documentation"
        title = first_line if first_line else f"Pydantic AI Documentation: {page_name}"

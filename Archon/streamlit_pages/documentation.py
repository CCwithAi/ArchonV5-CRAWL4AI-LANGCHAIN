...
from archon.crawl_pydantic_ai_docs import start_crawl_with_requests as start_pydantic_crawl, start_crawl_with_requests_async as start_pydantic_crawl_async, clear_existing_records as clear_pydantic_records
